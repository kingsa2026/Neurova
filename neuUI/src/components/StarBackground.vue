<template>
  <div class="star-background">
    ...
    <!-- 第二层尘带 — 反向移动 -->
    <div class="nebula-dust nebula-dust-2"></div>
    <!-- 微光粒子层 -->
    <div class="nebula-particles"></div>

    <!-- 第一层：大星星 3px，向下慢速 -->
    <div class="star-scroll-layer scroll-down" :style="{ animationDuration: '120s' }">
      <div
    ...
    <!-- 第二层：中等星星 2px，向上中速 -->
    <div class="star-scroll-layer scroll-up" :style="{ animationDuration: '50s' }">
      <div
    ...
    <div class="star-scroll-layer scroll-up" :style="{ animationDuration: '30s' }">
      <div
