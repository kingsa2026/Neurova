...
const cols = [
  { title: 'TraceID', dataIndex: 'id', width: 120 },
  { title: '端点', dataIndex: 'ep' },
  { title: '耗时', key: 'dur', width: 100 },
  { title: '状态', key: 'st', width: 80 },
  { title: '时间', dataIndex: 'time', width: 160 },
]
const list = ref([
  { id: 'tr-001', ep: 'POST /chat', dur: '230ms', dv: 230, st: '200', sc: 'green', time: '05-21 11:30:15' },
  { id: 'tr-002', ep: 'GET /memory', dur: '45ms', dv: 45, st: '200', sc: 'green', time: '05-21 11:30:10' },
  { id: 'tr-003', ep: 'POST /skills/install', dur: '890ms', dv: 890, st: '200', sc: 'green', time: '05-21 11:29:45' },
  { id: 'tr-004', ep: 'GET /knowledge/search', dur: '320ms', dv: 320, st: '200', sc: 'green', time: '05-21 11:29:30' },
  { id: 'tr-005', ep: 'POST /chat', dur: '540ms', dv: 540, st: '500', sc: 'red', time: '05-21 11:28:00' },
  { id: 'tr-006', ep: 'GET /agents', dur: '15ms', dv: 15, st: '200', sc: 'green', time: '05-21 11:27:45' },
