<template>
  <div class="pg">
    <div class="hd glass-effect">
      <h2 class="t"><ClockCircleOutlined :style="{color:'#34d399'}"/> 调度器</h2>
      <a-button type="primary" size="small"><PlusOutlined/>创建任务</a-button>
    </div>
    <div class="sr">
      <div class="s glass-effect">任务<b class="c1">{{ stats.total }}</b></div>
      <div class="s glass-effect">执行中<b class="c1">{{ stats.running }}</b></div>
      <div class="s glass-effect">成功率<b class="c1">{{ stats.successRate }}</b></div>
    </div>
