  ...
  <a-layout class="main-layout">
    ...
    <div class="top-bar">
      <div class="top-bar__left">
        <img :src="logoWhite" class="top-logo" alt="Neurova" @click="$router.push('/dashboard')" />
        <AppSidebar />
      </div>
      <div class="top-bar__right">
        <a-badge :count="3" size="small">
          <a-button type="text" class="top-icon-btn" @click="$router.push('/notifications')">
            <BellOutlined />
          </a-button>
        </a-badge>
        <a-dropdown>
          <div class="user-trigger">
            <a-avatar size="small" class="user-avatar">{{ usernameC }}</a-avatar>
