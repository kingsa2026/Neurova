...
凭据经 extra 传入。_create_adapter 必须
feishu: domain
...
def test_promote_dingtalk_client_id_to_canonical():
    from neurova.api.endpoints.channel_config import ChannelConfigRequest, _promote_credential_aliases
    ...
    _promote_credential_aliases("dingtalk", req)
...
def test_feishu_domain_forwarded_to_adapter():
    ...
    # domain 消费：lark → open.larksuite.com
