      ...
      <div v-else class="project-grid">
        ...
        >
          ...
          <div class="proj-actions">
            ...
            <a-popconfirm :title="t('common.confirm') + '?'" @confirm="handleDelete(proj.project_id ?? proj.id ?? '')">
...
function openEdit(p: Project) {
  editingId.value = p.project_id ?? p.id ?? null
  form.name = p.name
...
async function fetchProjects() {
  ...
  try {
    ...
    const data = (res as unknown as { data?: Project[] })?.data ?? res
