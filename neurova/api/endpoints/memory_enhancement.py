...
async def forget_memory(
    ...
    if mm and hasattr(mm, "forget_memory"):
        try:
            ...
            logger.warning(f"MemoryManager.forget_memory failed: {e}")
...
async def strengthen_memory(
    ...
    if mm and hasattr(mm, "strengthen_memory"):
        try:
            ...
            logger.warning(f"MemoryManager.strengthen_memory failed: {e}")
    ...
    for memory_id in body.memory_ids:
        ...
        try:
            if body.operation == "forget":
                threshold = body.params.get("importance_threshold", 0.3)
