...
class IconDetector:
    ...
    def __init__(self, model_path: str = None, device: str = None):
        ...
        self._init_model()
        logger.debug("IconDetector 初始化完成, device=%s", self.device)
    ...
    def _init_model(self) -> None:
        ...
        try:
            ...
            if self.model_path and Path(self.model_path).exists():
                ...
                logger.info("已加载图标检测模型: %s", self.model_path)
            else:
...
class VisualParser:
    ...
    def __init__(self, model_path: str = None, device: str = None):
        ...
        self._loaded = False
        logger.info("VisualParser 初始化完成, device=%s", self.device)
