...
class StateError(NeurovaError):
    ...
    def __init__(self, message: str, module: str = "", original_exception: Optional[Exception] = None):
        super().__init__(
            code=ErrorCode.INVALID_STATE, message=message, module=module, original_exception=original_exception
        )
...
class ConfigError(NeurovaError):
    ...
    def __init__(self, message: str, module: str = "", original_exception: Optional[Exception] = None):
        super().__init__(
            code=ErrorCode.CONFIG_INVALID, message=message, module=module, original_exception=original_exception
        )
...
class ErrorHandler:
    ...
    def handle(
        self, exception: Exception, module: str = "", context: typing.Dict[str, typing.Any] = None
    ) -> ErrorRecord:
        """处理异常
    ...
    def handle_code(
        self, code: ErrorCode, message: str, module: str = "", context: typing.Dict[str, typing.Any] = None
    ) -> ErrorRecord:
        """处理指定错误码
    ...
    def _try_recover(self, exception: Exception, code: ErrorCode, module: str) -> typing.Tuple[bool, bool]:
        ...
        try:
            ...
            self._logger.error("恢复策略执行失败: %s", recovery_error)
            return True, False
    ...
    def get_records(
        self, code: Optional[ErrorCode] = None, module: Optional[str] = None, limit: int = 100
    ) -> typing.List[ErrorRecord]:
        """获取错误记录
    ...
    def _add_record(self, record: ErrorRecord) -> None:
        ...
        # 记录到日志
        self._logger.error("错误 [%s] %s (模块: %s)", record.code.name, record.message, record.module)
    ...
    def _trigger_callbacks(self, record: ErrorRecord) -> None:
        ...
        for callback in self._error_callbacks:
            try:
                ...
                self._logger.error("错误回调执行失败: %s", e)
