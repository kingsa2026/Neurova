...
class AutonomousSkillSecurityAssessor:
    ...
    def assess_skill(self, skill_data: Dict[str, Any]) -> SkillAssessmentResult:
        ...
        try:
            ...
            # 计算总体评分
            security_score = self._calculate_overall_score(
                behavior_analysis, code_quality, risk_assessment
            )
            ...
            logger.info("Skill assessment completed for %s: score=%.2f, risk=%s",
                       skill_name, security_score.overall_score, risk_assessment.risk_level.value)
    ...
    def _assess_risk(self, skill_data: Dict[str, Any], behavior_analysis: Dict[str, Any]) -> RiskAssessment:
        ...
        try:
            ...
            if behavior_analysis.get('file_operations'):
                risk_factors.append({
                    'factor': 'file_operations',
                    'level': 'medium',
                    'description': '技能包含文件操作'
                })
    ...
    def _calculate_overall_score(self, behavior_analysis: Dict[str, Any],
                                ...
                                risk_assessment: RiskAssessment) -> SecurityScore:
        """
        计算总体安全评分
    ...
    def get_assessment_history(self, skill_id: Optional[str] = None,
