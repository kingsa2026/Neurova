...
class MediaStorageConfig:
    ...
    def get_media_path(self, agent_id: str, filename: str,
...
class MediaStorageConfigManager:
    ...
    def __init__(self, config_dir: Optional[Path] = None):
        ...
        logger.info(f"MediaStorageConfigManager initialized: {self.config_dir}")
    ...
    def save_config(self, agent_id: str, config: MediaStorageConfig) -> bool:
        ...
        with self._lock:
            try:
                ...
                logger.info(f"Saved media config for agent {agent_id}")
                return True
                
            except Exception as e:
                logger.error(f"Failed to save media config for agent {agent_id}: {e}")
                return False
    ...
    def delete_config(self, agent_id: str) -> bool:
        ...
        with self._lock:
            try:
                ...
                logger.info(f"Deleted media config for agent {agent_id}")
                return True
                
            except Exception as e:
                logger.error(f"Failed to delete media config for agent {agent_id}: {e}")
                return False
