...
class VectorSearch:
    ...
    def __init__(
        ...
        logger.info("VectorSearch initialized: %s documents", len(self._documents))
    ...
    def _load_index(self) -> bool:
        ...
        try:
            ...
            logger.info("Index loaded: %s documents", len(self._documents))
            return True
    ...
    def save_index(self) -> bool:
        ...
        try:
            ...
            logger.info("Index saved: %s documents", len(self._documents))
            return True
    ...
    def _tokenize(self, text: str) -> List[str]:
        ...
        # 过滤停用词和短词
        tokens = [token for token in tokens if token not in self._stop_words and len(token) > 1]
    ...
    def add_texts(
        ...
        logger.info("Added %s documents", len(added_ids))
        return added_ids
    ...
    def rebuild_index(self) -> None:
        ...
        with self._lock:
            ...
            logger.info("Index rebuilt: %s documents", len(self._documents))
