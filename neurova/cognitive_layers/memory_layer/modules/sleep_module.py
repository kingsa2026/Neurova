...
class SleepModule:
    ...
    def end_sleep(self) -> Dict[str, int]:
        ...
        with self._lock:
            ...
            logger.info(f"Sleep ended: {stats}")
            return stats
    ...
    def consolidate_memory(
        ...
        with self._lock:
            ...
            logger.debug(f"Consolidated memory '{memory_id}' (importance={importance:.2f})")
            return True
    ...
    def cleanup_memory(
        ...
        with self._lock:
            ...
            logger.debug(f"Cleaned up memory '{memory_id}' (importance={importance:.2f})")
            return True
        ...
        with self._lock:
            ...
            if self._on_dream:
                try:
                    ...
                    logger.warning(f"Dream callback failed: {e}")
            
            logger.debug(f"Dream generated from memories: {selected_ids}")
            return dream_result
