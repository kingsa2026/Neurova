...
class BM25Scorer:
    ...
    def __init__(
        ...
        logger.info("BM25Scorer initialized: k1=%s, b=%s", k1, b)
    ...
    def fit(self, documents: List[Dict[str, Any]]) -> None:
        ...
        with self._lock:
            ...
            logger.info("BM25 fitted: %s documents, %s terms", self._doc_count, len(self._vocabulary))
    ...
    def remove(self, doc_id: str) -> bool:
        ...
        with self._lock:
            ...
            # 获取文档信息
            self._doc_lengths.get(doc_id, 0)

            # 更新词频统计
            for term in self._vocabulary:
                if doc_id in self._term_freq.get(term, {}):
                    self._term_freq[term][doc_id]
