...
class GraphTraversal:
    ...
    def probabilistic_beam_search(self, start_ids: List[str], query_vector: List[float] = None,
                                 beam_width: int = 3, max_depth: int = 3) -> TraversalResult:
        """概率束搜索算法
    ...
    def compute_attention_weight(self, query_vector: List[float], node_vector: List[float],
                               intent_weight: float = 1.0) -> float:
        """计算注意力权重
