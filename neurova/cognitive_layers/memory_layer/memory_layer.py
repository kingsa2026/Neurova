...
class AgentMemoryLayer:
    ...
    def __init__(
        ...
        logger.info(f"AgentMemoryLayer created: agent_id={agent_id}, neuser_id={neuser_id}, user_id={user_id}")
            ...
            try:
                ...
                if self._storage:
                    ...
                    self._recall_engine = NeurovaRecallEngine(
                        ...
                        tkg=None,
                        vector_search=None,
                        config=self._config.get("recall_config", {
                ...
                logger.info(f"AgentMemoryLayer initialized: agent_id={self._agent_id}")
                
            except Exception as e:
                import traceback
                logger.error(
                    f"AgentMemoryLayer initialization failed: {e}\n"
    ...
    def remember(self, content: str, category: str = "general", metadata: Optional[Dict] = None) -> str:
        ...
        try:
            ...
            logger.debug(f"Memory stored: {memory_id[:8]}...")
            return memory_id
        except Exception as e:
    ...
    def get_memory(self, memory_id: str) -> Optional[Dict]:
        ...
        try:
            ...
            logger.warning(f"Failed to get memory {memory_id[:8]}...: {e}")
            return None
    ...
    def update_memory(self, memory_id: str, updates: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            logger.error(f"Failed to update memory {memory_id[:8]}...: {e}")
            return False
    ...
    def delete_memory(self, memory_id: str) -> bool:
        ...
        try:
            ...
            logger.error(f"Failed to delete memory {memory_id[:8]}...: {e}")
            return False
    ...
    def run_decay_cycle(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.debug(f"Decay cycle completed: {result}")
            return result
        except Exception as e:
            ...
            for memory in all_memories:
                ...
                if memory_id:
                    try:
                        ...
                        logger.warning(f"Failed to delete memory {memory_id[:8]}...: {e}")
            
            logger.info(f"Cleared {deleted_count} memories for agent {self._agent_id}")
    ...
    def shutdown(self):
        ...
        with self._lock:
            ...
            try:
                ...
                logger.info(f"AgentMemoryLayer shutdown: agent_id={self._agent_id}")
