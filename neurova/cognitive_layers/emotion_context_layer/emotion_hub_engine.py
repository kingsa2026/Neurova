...
class EmotionHubEngine:
    ...
    _EMOTION_KEYWORDS: Dict[str, List[str]] = {
        "joy": ["开心", "快乐", "高兴", "喜悦", "幸福", "愉快", "兴奋", "欣喜", "欢乐", "满足", "happy", "joy", "glad", "excited", "pleased"],
        "sadness": ["悲伤", "难过", "伤心", "忧郁", "沮丧", "失落", "痛苦", "哀伤", "sad", "sorrow", "grief", "depressed", "melancholy"],
        "anger": ["愤怒", "生气", "恼火", "暴怒", "气愤", "恼怒", "愤慨", "angry", "furious", "rage", "irritated", "annoyed"],
        "fear": ["恐惧", "害怕", "担心", "焦虑", "紧张", "不安", "惊恐", "畏惧", "afraid", "fear", "anxious", "worried", "scared"],
    ...
    _INTENSITY_MODIFIERS: Dict[str, float] = {
        "非常": 1.5, "极其": 2.0, "特别": 1.4, "十分": 1.3, "相当": 1.2,
        "有点": 0.7, "稍微": 0.6, "略微": 0.5, "一点": 0.6, "些许": 0.5,
        "very": 1.5, "extremely": 2.0, "quite": 1.2, "somewhat": 0.7, "slightly": 0.6,
    }
    ...
    def analyze_text(self, text: str) -> Dict[str, float]:
        ...
        with self._lock:
            try:
                ...
                logger.debug(f"文本情感分析结果: {emotion_scores}")
        ...
        for rule in self._conduction_rules:
            ...
            if source_score > 0.3:
                ...
                if random.random() < conduction_prob:
                    ...
                    logger.debug(f"情感传导: {rule.source_emotion} -> {rule.target_emotion} (+{conduction_amount:.2f})")
    ...
    def clear(self) -> None:
        ...
        with self._lock:
            ...
            logger.info(f"EmotionHubEngine 数据已清空 (agent_id={self._agent_id})")
