...
class EmotionConductionManager:
    ...
    def __init__(self, agent_id: str = "default"):
        ...
        logger.info(f"EmotionConductionManager 初始化完成 (agent_id={agent_id})")
    ...
    def reset_to_baseline(self) -> None:
        ...
        with self._lock:
            ...
            logger.info(f"情感状态已重置到基线 (agent_id={self._agent_id})")
    ...
    def merge_with_user_emotion(
        ...
        with self._lock:
            try:
                ...
                logger.debug(f"情感融合完成 (weight={weight})")
    ...
    def update_from_text(
        ...
        with self._lock:
            try:
                ...
                logger.debug(f"从文本更新情感状态: {emotion_scores}")
                return result
                
            except Exception as e:
                logger.error(f"从文本更新情感状态失败: {e}")
                return self._hub_engine.get_emotion_distribution()
