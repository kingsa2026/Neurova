        ...
        try:
            ...
            if documents:
                ...
                if hasattr(vector_search, "build_index"):
                    ...
                    logger.info("重建向量索引，包含 %s 个文档", len(documents))
