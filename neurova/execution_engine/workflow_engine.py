...
class WorkflowNode:
    ...
    def to_dict(self) -> typing.Dict[str, typing.Any]:
        return {
            ...
            "node_type": self.node_type.value, "action": self.action,
            "parameters": self.parameters, "next_nodes": self.next_nodes,
            "condition": self.condition, "timeout": self.timeout
        }
...
class WorkflowDefinition:
    ...
    def to_dict(self) -> typing.Dict[str, typing.Any]:
        return {
            ...
            "start_node": self.start_node, "variables": self.variables,
...
class WorkflowInstance:
    ...
    def to_dict(self) -> typing.Dict[str, typing.Any]:
        return {
            ...
            "status": self.status.value, "current_node": self.current_node,
            "start_time": self.start_time.isoformat() if self.start_time else None,
            "end_time": self.end_time.isoformat() if self.end_time else None,
            "duration": self.duration,
            "node_results": self.node_results, "errors": self.errors
        }
...
class WorkflowEngine:
    ...
    def register_workflow(self, definition: WorkflowDefinition) -> None:
        ...
        with self._lock:
            ...
            logger.debug(f"工作流已注册: {definition.name}")
    ...
    def list_workflows(self) -> typing.List[typing.Dict[str, typing.Any]]:
        """列出工作流"""
        return [
            {"workflow_id": wf.workflow_id, "name": wf.name, "nodes": len(wf.nodes)}
    ...
    def register_action(self, action_name: str, handler: typing.Callable) -> None:
        ...
        logger.debug(f"动作已注册: {action_name}")
    ...
    async def _execute_task(self, node: WorkflowNode, instance: WorkflowInstance) -> typing.Any:
        ...
        # 默认：返回参数
        logger.warning(f"未找到动作处理器: {action}")
