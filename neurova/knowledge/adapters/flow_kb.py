...
class FlowKBClient:
    ...
    def __init__(self, api_key: str, api_base: str = "https://api.iflow.com"):
        ...
        logger.info(f"FlowKBClient initialized: {api_base}")
    ...
    async def list_collections(self, limit: int = 100, 
                              offset: int = 0) -> List[Collection]:
        """
        列出知识库集合
    ...
    async def update_collection(self, collection_id: str, 
                               updates: Dict[str, Any]) -> Optional[Collection]:
        """
        更新知识库集合
        ...
        """
        try:
            result = await self._request("PUT", f"/collections/{collection_id}", 
                                        json=updates)
            return Collection.from_dict(result)
        except Exception as e:
    ...
    async def upload_document(self, collection_id: str, document: Document) -> Optional[Document]:
        ...
        try:
            result = await self._request("POST", f"/collections/{collection_id}/documents", 
                                        json=data)
    ...
    async def import_url(self, collection_id: str, url: str, 
        ...
        try:
            result = await self._request("POST", f"/collections/{collection_id}/import", 
                                        json=data)
            return Document.from_dict(result)
        except Exception as e:
    ...
    async def list_documents(self, collection_id: str, 
        ...
        """
        params = {"limit": limit, "offset": offset}
        result = await self._request("GET", f"/collections/{collection_id}/documents", 
                                    params=params)
    ...
    async def search(self, collection_id: str, query: str, 
                    limit: int = 10, 
        ...
        try:
            result = await self._request("POST", f"/collections/{collection_id}/search", 
                                        json=data)
    ...
    async def start_web_search(self, query: str, 
        ...
        try:
            ...
            logger.error(f"Failed to start web search: {e}")
            return None
    ...
    async def get_web_search_result(self, task_id: str) -> Optional[List[SearchResult]]:
        ...
        try:
            ...
            logger.error(f"Failed to get web search result: {e}")
            return None
...
class FlowKBAdapter:
    ...
    async def initialize(self) -> bool:
        ...
        try:
            ...
            logger.error(f"Failed to initialize FlowKBAdapter: {e}")
            return False
    ...
    async def create_knowledge_base(self, name: str, description: str = "",
                                   metadata: Optional[Dict[str, Any]] = None) -> Optional[Collection]:
        """
        创建知识库
    ...
    async def list_knowledge_bases(self, limit: int = 100, 
                                  offset: int = 0) -> List[Collection]:
        """
        列出知识库
    ...
    async def add_document(self, collection_id: Optional[str] = None,
                          title: str = "", content: str = "",
                          content_type: ContentType = ContentType.TEXT,
                          source: str = "", author: str = "",
                          tags: Optional[List[str]] = None,
                          metadata: Optional[Dict[str, Any]] = None) -> Optional[Document]:
        """
        添加文档
    ...
    async def list_documents(self, collection_id: Optional[str] = None,
                            limit: int = 100, offset: int = 0) -> List[Document]:
        """
        列出文档
    ...
    async def delete_document(self, collection_id: Optional[str] = None,
    ...
    async def search(self, collection_id: Optional[str] = None,
    ...
    async def search_multi_collection(self, collection_ids: List[str],
