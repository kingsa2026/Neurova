...
class QClawBinding:
    ...
    def __init__(self, id: int = 0, neuser_id: str = "", user_id: str = "",
                 app_id: str = "", app_secret_encrypted: str = "",
                 app_name: str = "", webhook_url: str = "",
                 status: str = "active", created_at: str = "",
                 updated_at: str = "", last_used_at: str = None,
                 extra_config: str = "{}"):
        self.id = id
...
class QClawBindingModel:
    ...
    def create_binding(self, neuser_id: str, user_id: str, app_id: str,
                       app_secret: str, app_name: str = None,
                       webhook_url: str = None, extra_config: dict = None) -> QClawBinding:
        """
        创建新的QClaw绑定
        ...
        try:
            ...
            if cursor.fetchone():
                conn.close()
                raise ValueError(f"Binding already exists for neuser_id={neuser_id}, user_id={user_id}, app_id={app_id}")
    ...
    def list_user_bindings(self, neuser_id: str, user_id: str = None,
    ...
    def _encrypt_secret(self, secret: str) -> str:
        ...
        if not HAS_CRYPTOGRAPHY or not self.encryption_key:
            ...
            # 注意：这不是安全的加密，只是编码
            logger.warning("Using Base64 encoding instead of encryption (cryptography not available or no key provided)")
