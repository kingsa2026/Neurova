    ...
    def verify_code(
        ...
        try:
            ...
            if not verification_code.is_valid:
                logger.warning("Verification code is not valid for %s (expired=%s, used=%s, used_up=%s)", 
                             target, verification_code.is_expired, verification_code.is_used, verification_code.is_used_up)
                return False
