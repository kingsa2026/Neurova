...
class NeurflowAgentManager:
    ...
    def create_agent(
        self, name: str, role: str, config: Optional[Dict[str, Any]] = None, flow_id: Optional[str] = None
    ) -> AgentInfo:
        """创建临时团队 Agent
    ...
    def list_agents(self, flow_id: Optional[str] = None, include_archived: bool = False) -> List[AgentInfo]:
        """列出 Agent
