...
from .dag import DAGValidator, get_dag_validator
    ...
    async def execute(
        ...
        try:
            for node_id in execution_order:
                ...
                # 解析节点配置
                resolved_config = self._variable_resolver.resolve_config(
                    node.config, resolution_context
                )
            ...
            if instance.node_results:
                ...
                if last_node_id in instance.node_results:
                    instance.outputs = {
                        "result": instance.node_results[last_node_id].output
                    }
