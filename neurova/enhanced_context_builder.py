...
class EnhancedContextBuilder:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        stats["sessions"] = {sid: len(msgs) for sid, msgs in self._sessions.items()}
    ...
    def _compress_context(self, context: Dict[str, Any], token_budget: int) -> Dict[str, Any]:
        """压缩上下文以适应 token 预算。
    ...
    def _build_cache_key(self, query: str, session_id: Optional[str], include_memories: bool) -> str:
        """构建缓存键。"""
