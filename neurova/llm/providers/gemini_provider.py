...
class GeminiProvider(BaseProvider):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        super().__init__(
            provider_id=provider_id, provider_type=ProviderType.GEMINI, api_key=api_key, base_url=base_url, **kwargs
        )
    ...
    async def create_chat_model(self, model_id: str, **kwargs) -> typing.Any:
        ...
        model = ChatGoogleGenerativeAI(model=model_id, google_api_key=self.api_key, **config)
...
def create_gemini_provider(
    api_key: str, base_url: str = "https://generativelanguage.googleapis.com", **kwargs
) -> GeminiProvider:
    ...
    Returns:
        GeminiProvider 实例
    """
    return GeminiProvider(provider_id="gemini", api_key=api_key, base_url=base_url, **kwargs)
