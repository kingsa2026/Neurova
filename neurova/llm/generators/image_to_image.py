    ...
    def __init__(
        ...
        **kwargs
        ...
        super().__init__(
            ...
            generator_type=GeneratorType.IMAGE_TO_IMAGE,
            **kwargs
        )
        ...
        self.logger.info(f"ImageToImageGenerator 初始化完成: provider={provider}")
