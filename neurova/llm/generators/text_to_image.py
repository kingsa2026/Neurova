    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            ...
            **kwargs: 其他配置参数
        """
        super().__init__(generator_id=generator_id, generator_type=GeneratorType.TEXT_TO_IMAGE, **kwargs)
        self.api_key = api_key
        self.base_url = base_url
        self.provider = provider
        self._initialized = True

        self.logger.info("TextToImageGenerator 初始化完成: provider=%s", provider)
...
def create_text_to_image_generator(
    ...
    return TextToImageGenerator(
        generator_id="text_to_image", api_key=api_key, base_url=base_url, provider=provider, **kwargs
    )
