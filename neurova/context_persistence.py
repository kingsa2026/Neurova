...
class ContextPersistence:
    ...
    def save_context(
        ...
        try:
            ...
            logger.debug("Saved context for session '%s' (agent='%s')", session_id, agent_id)
            return True
    ...
    def load_context(
        ...
        try:
            ...
            logger.debug("Loaded context for session '%s' (agent='%s')", session_id, agent_id)
            return data
    ...
    def load_context_by_channel(
        ...
        try:
            ...
            logger.error("Failed to load contexts by channel: %s", e)
            return []
    ...
    def list_contexts(
        ...
        try:
            ...
            logger.error("Failed to list contexts: %s", e)
            return []
    ...
    def get_context_stats(self, agent_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error("Failed to get context stats: %s", e)
    ...
    def get_context_stats_by_channel(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error("Failed to get channel stats: %s", e)
            return {"error": str(e)}
    ...
    def cleanup_old_contexts(
        ...
        try:
            ...
            if deleted > 0:
                logger.info("Cleaned up %s old contexts (max_age=%s days)", deleted, max_age_days)
            return deleted

        except Exception as e:
            logger.error("Failed to cleanup contexts: %s", e)
            return 0
