...
class UnifiedRetrieverAdapter:
    ...
    async def retrieve(self, context) -> Any:
        ...
        try:
            ...
            logger.error(f"UnifiedRetriever failed: {e}")
            raise
...
class MoERetrieverAdapter:
    ...
    async def retrieve(self, context) -> Any:
        ...
        try:
            ...
            logger.error(f"MoERetriever failed: {e}")
            raise
...
class CacheRetrieverAdapter:
    ...
    async def retrieve(self, context) -> Any:
        ...
        try:
            ...
            logger.error(f"CacheRetriever failed: {e}")
            raise
...
class FallbackRetrieverAdapter:
    ...
    async def retrieve(self, context) -> Any:
        ...
        try:
            ...
            logger.error(f"FallbackRetriever failed: {e}")
            raise
