...
class SkillPackager:
    ...
    def package_for_sharing(
        ...
        try:
            ...
            logger.info(f"Packaged skill '{skill_id}' for sharing: {package_path}")
            return package_path
    ...
    def package_for_evolution(
        ...
        try:
            ...
            logger.info(f"Packaged skill '{skill_id}' for evolution: {package_path}")
            return package_path
            
        except Exception as e:
            logger.error(f"Failed to package skill '{skill_id}' for evolution: {e}")
            if package_path.exists():
                package_path.unlink()
            return None
    ...
    def unpack_package(
        ...
        try:
            with zipfile.ZipFile(package_path, 'r') as zf:
                ...
                logger.info(f"Unpacked package to: {target}")
                return meta
            ...
            logger.error(f"Failed to unpack package: {e}")
            return None
