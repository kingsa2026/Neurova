...
class SkillMarketAdapter(ABC):
    ...
    def __init__(self, name: str, base_url: str = ""):
        ...
        logger.info("Initialized %s adapter", name)
...
class SkillsShAdapter(SkillMarketAdapter):
    ...
    def search(self, query: str, limit: int = 10) -> List[SkillInfo]:
        ...
        try:
            ...
            logger.error("Failed to search Skills.sh: %s", e)
    ...
    def install(self, skill_info: SkillInfo, target_dir: str) -> bool:
        ...
        try:
            ...
            logger.info("Installed %s from Skills.sh", skill_info.name)
            return True

        except Exception as e:
            logger.error("Failed to install from Skills.sh: %s", e)
            return False
    ...
    def get_skill_info(self, skill_name: str) -> Optional[SkillInfo]:
        ...
        try:
            ...
            logger.error("Failed to get skill info from Skills.sh: %s", e)
            return None
...
class ClawHubAdapter(SkillMarketAdapter):
    ...
    def search(self, query: str, limit: int = 10) -> List[SkillInfo]:
        ...
        try:
            ...
            logger.error("Failed to search ClawHub: %s", e)
    ...
    def install(self, skill_info: SkillInfo, target_dir: str) -> bool:
        ...
        try:
            ...
            logger.info("Installed %s from ClawHub", skill_info.name)
            return True
    ...
    def get_skill_info(self, skill_name: str) -> Optional[SkillInfo]:
        ...
        try:
            ...
            logger.error("Failed to get skill info from ClawHub: %s", e)
            return None
...
class SkillsMPAdapter(SkillMarketAdapter):
    ...
    def search(self, query: str, limit: int = 10) -> List[SkillInfo]:
        ...
        try:
            ...
            logger.error("Failed to search SkillsMP: %s", e)
    ...
    def install(self, skill_info: SkillInfo, target_dir: str) -> bool:
        """从 SkillsMP 安装技能"""
        # 类似于其他适配器的实现
        logger.info("Installing %s from SkillsMP", skill_info.name)
        return True
    ...
    def get_skill_info(self, skill_name: str) -> Optional[SkillInfo]:
        ...
        try:
            ...
            logger.error("Failed to get skill info from SkillsMP: %s", e)
            return None
...
class LobeHubAdapter(SkillMarketAdapter):
    ...
    def install(self, skill_info: SkillInfo, target_dir: str) -> bool:
        ...
        try:
            ...
            logger.info("Installed %s from LobeHub", skill_info.name)
            return True
    ...
    def get_skill_info(self, skill_name: str) -> Optional[SkillInfo]:
        ...
        try:
            ...
            logger.error("Failed to get skill info from LobeHub: %s", e)
            return None
...
class SkillMarketRegistry:
    ...
    def register_adapter(self, market_name: str, adapter: SkillMarketAdapter):
        ...
        logger.info("Registered adapter for market: %s", market_name)
    ...
    def parse_url(self, url: str) -> Optional[Dict[str, Any]]:
        ...
        if match:
            return {"market": "github", "owner": match.group(1), "repo": match.group(2), "url": url}

        # LobeHub URL 模式
        lobehub_pattern = r"https?://lobehub\.com/skills/([^/]+)"
        match = re.match(lobehub_pattern, url)
        if match:
            return {"market": "lobehub", "skill_name": match.group(1), "url": url}
