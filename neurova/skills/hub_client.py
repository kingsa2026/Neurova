    ...
    for attempt in range(retries + 1):
        try:
            ...
            if attempt < retries:
                ...
                logger.warning(f"HTTP request failed (attempt {attempt + 1}), retrying in {backoff:.1f}s: {e}")
                time.sleep(backoff)
            else:
                logger.error(f"HTTP request failed after {retries + 1} attempts: {e}")
                raise
...
class SkillHubClient:
    ...
    def register_source(self, name: str, source_type: SkillSource, config: Dict[str, Any]) -> None:
        ...
        logger.debug(f"Registered skill source: {name}")
    ...
    def search_skills(self, query: str, sources: List[str] = None, limit: int = 20) -> List[RemoteSkill]:
        ...
        for source_name in sources:
            ...
            try:
                ...
                logger.error(f"Failed to search {source_name}: {e}")
    ...
    def _search_lobehub(self, query: str, limit: int = 20) -> List[RemoteSkill]:
        ...
        try:
            ...
            logger.error(f"LobeHub search failed: {e}")
            return []
    ...
    def install_skill(self, skill: RemoteSkill) -> bool:
        ...
        try:
            if skill.source == SkillSource.GITHUB:
                ...
                logger.error(f"Unsupported source for installation: {skill.source}")
                return False
    ...
    def _install_from_github(self, skill: RemoteSkill) -> bool:
        ...
        try:
            ...
            logger.info(f"Installed skill {skill.name} from GitHub")
            return True
    ...
    def _install_from_clawhub(self, skill: RemoteSkill) -> bool:
        ...
        try:
            ...
            logger.info(f"Installed skill {skill.name} from ClawHub")
            return True
    ...
    def _install_from_lobehub(self, skill: RemoteSkill) -> bool:
        ...
        try:
            ...
            logger.info(f"Installed skill {skill.name} from LobeHub")
            return True
    ...
    def get_skill_latest_version(self, skill: RemoteSkill) -> str:
        ...
        try:
            if skill.source == SkillSource.GITHUB:
                ...
                logger.error(f"Unsupported source for version check: {skill.source}")
    ...
    def _get_github_skill_version(self, skill: RemoteSkill) -> str:
        ...
        try:
            ...
            logger.warning(f"Failed to get GitHub version: {e}")
            return skill.version
    ...
    def _get_clawhub_skill_version(self, skill: RemoteSkill) -> str:
        ...
        try:
            ...
            logger.warning(f"Failed to get ClawHub version: {e}")
            return skill.version
    ...
    def _get_lobehub_skill_version(self, skill: RemoteSkill) -> str:
        ...
        try:
            ...
            logger.warning(f"Failed to get LobeHub version: {e}")
            return skill.version
    ...
    def update_skill(self, skill: RemoteSkill) -> bool:
        ...
        try:
            ...
            if latest_version == skill.version:
                logger.info(f"Skill {skill.name} is already up to date")
                return True
    ...
    def list_remote_skills(self, source: str = None, limit: int = 50) -> List[RemoteSkill]:
        ...
        for source_name in sources:
            try:
                ...
                logger.error(f"Failed to list skills from {source_name}: {e}")
    ...
    def _list_github_skills(self, limit: int = 50) -> List[RemoteSkill]:
        ...
        try:
            ...
            logger.error(f"Failed to list GitHub skills: {e}")
            return []
    ...
    def _list_lobehub_skills(self, limit: int = 50) -> List[RemoteSkill]:
        ...
        try:
            ...
            logger.error(f"Failed to list LobeHub skills: {e}")
            return []
