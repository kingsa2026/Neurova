...
class ToolSchemaConverter:
    ...
    def google_to_openai(self, google_schema: GoogleToolSchema) -> OpenAIFunctionSchema:
        """Google 到 OpenAI 转换"""
        return OpenAIFunctionSchema(
            name=google_schema.name,
            description=google_schema.description,
    ...
    def convert_to_dict(
        self, 
        schema: typing.Union[OpenAIFunctionSchema, AnthropicToolSchema, GoogleToolSchema],
        format: str = "openai"
...
class ToolCallParser:
    ...
    def parse_google_tool_call(self, tool_call: typing.Dict[str, typing.Any]) -> typing.Dict[str, typing.Any]:
        ...
        return {
            ...
            "arguments": self.parse_arguments(function_call.get("args", {}))
        }
    ...
    def parse_arguments(self, arguments: typing.Union[str, typing.Dict[str, typing.Any]]) -> typing.Dict[str, typing.Any]:
        """
        解析参数
