...
class CLIToolExecutor:
    ...
    def execute_sync(
        ...
        try:
            ...
            result = subprocess.run(
                cleaned_command, shell=True, capture_output=True, text=True, timeout=timeout, cwd=cwd, env=env
            )
            ...
            return {"success": False, "output": "", "error": str(e), "return_code": -1, "risk": risk}
    ...
    def create_cli_tool(
        ...
        logger.info("Created CLI tool: %s", name)
        return tool

    def execute_cli_tool(
        self, tool_name: str, params: typing.Dict[str, typing.Any], timeout: typing.Optional[float] = None
    ) -> typing.Dict[str, typing.Any]:
        """
        执行 CLI 工具
        ...
        if tool_name not in self._cli_tools:
            return {"success": False, "output": "", "error": f"CLI tool '{tool_name}' not found", "return_code": -1}
        ...
        if validation_error:
            return {"success": False, "output": "", "error": validation_error, "return_code": -1}
    ...
    def _validate_params(
        self, tool: typing.Dict[str, typing.Any], params: typing.Dict[str, typing.Any]
    ) -> typing.Optional[str]:
        """
        验证参数
