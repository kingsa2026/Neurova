...
class ToolExecutionLogger:
    ...
    def __init__(self, log_file: str = "tool_execution.jsonl", buffer_size: int = 100, auto_flush: bool = True):
        ...
        logger.info("ToolExecutionLogger initialized: %s", log_file)
    ...
    def flush(self) -> None:
        ...
        try:
            ...
            logger.debug("Flushed %s entries to %s", len(self._buffer), self._log_file)
    ...
    def query_recent(
        ...
        try:
            ...
            logger.warning("Log file not found: %s", self._log_file)
            return []
    ...
    def close(self) -> None:
        ...
        logger.info("ToolExecutionLogger closed: %s", self._log_file)
